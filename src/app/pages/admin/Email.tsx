...
const EmailSetting = () => {
    ...
    const handlTestMail = () => {
        testMail.submit()
        const values = testMail.getFieldsValue()
        console.log(values)
        }
        ...
        <Card style={{ margin: '20px', backgroundColor: '#f0f2f5' }} title="Cấu hình email ">
            <Spin spinning={loading} tip="Loading...">
                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                    ...
                    <Card title="Nhập mail để test">
                        <Form form={testMail}>
                            <Form.Item label="Nhập Email bất kỳ để test " name="testEmail">
                                <Input />
                            </Form.Item>

                            <Form.Item label="Nội dung test" name="testContent">
                                <Input />
                            </Form.Item>

                            <Button type="primary" onClick={() => handlTestMail()}>
                                Test
                            </Button>
                        </Form>
